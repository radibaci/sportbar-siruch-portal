/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.v2.jsonc --env-interface=CloudflareBindings worker-v2/worker-configuration.d.ts` (hash: f13814e249c7e37e5d3dc7ecebf9aca3)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	MEDIA: R2Bucket;
	DB: D1Database;
	APP_ENV: "development";
	ALLOWED_ORIGINS: "http://localhost:4173,http://localhost:4213,http://localhost:8788,https://radibaci.github.io";
	SESSION_COOKIE_NAME: "tennis_portal_session";
	VAPID_SUBJECT: "mailto:portal@sportbarsiruch.cz";
	VAPID_PUBLIC_KEY: "BFkFSbssKeGVcq0RsTk-VBPngH9XRloEHaAnwjt2kRNJEgTdCm7VQwN93WTTzofnu6afsOpJhAKHCwtGdwG3ZNg";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ALLOWED_ORIGINS" | "SESSION_COOKIE_NAME" | "VAPID_SUBJECT" | "VAPID_PUBLIC_KEY">> {}
}
