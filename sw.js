const CACHE_NAME = "tennis-club-portal-v78";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=74",
  ...
  "./assets/app-icon-192.png?v=74",
  "./assets/app-icon-512.png?v=74",
  "./assets/club-logo-dm.png?v=74",
  "./assets/club-logo-dm-192.png?v=74",
  "./assets/club-logo-dm-512.png?v=74",
