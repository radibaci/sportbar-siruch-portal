const CACHE_NAME = "tennis-club-portal-v77";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=73",
  ...
  "./assets/app-icon-192.png?v=73",
  "./assets/app-icon-512.png?v=73",
  "./assets/club-logo-dm.png?v=73",
  "./assets/club-logo-dm-192.png?v=73",
  "./assets/club-logo-dm-512.png?v=73",
